...
public protocol DeeplinkHandling {
    ...
    /// Is there a `Deeplink` associated with the provided `URL` supported by this module?
    /// - Parameter url: The `URL` to check.
    /// - Returns: `True` if there is a `Deeplink` associated with the provided `URL` that can be handled by this module.
